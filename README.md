...
## Streamlit Cloud Dependency Fix
...
This fixed version uses Python 3.10.13 and dependency versions that are usually more stable with MediaPipe on Streamlit Cloud.
